...
WELCOME_MESSAGE = """👋 Привет! Ты активировал Salyev bot. 

Бот ежедневно присылает заявки на твои услуги

⭐️ «Категории заявок» 
Выбирай нужную категорию, по которой хочешь 
получать заявки

⭐️ «Реферальная система» 
Получи реферальную ссылку и отправь ее
друзьям для регистрации и с каждой
оплаты будешь получать до 50% на свой
счет. 

⭐️ «Полезное» 
Статьи и инструкции по работе с ботом

⭐️ «Разместить объявление» 
Размести вакансию о поиске специалиста

⭐️ «Техподдержка» 
По всем вопросам о работе бота

⭐️ "Заказать направление" 
Заказать разработку категории для себя"""
